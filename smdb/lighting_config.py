...
SPOTLIGHT_RADIAL_FALLOFF = 15.0  # Radial falloff from center to edge (higher = darker edges, 0 = no falloff)
SPOTLIGHT_CENTER_BOOST = 1.0    # Center brightness boost (higher = brighter center)
SPOTLIGHT_CENTER_COLOR = (1.0, 0.7, 0.5)  # Light color at center of cone (RGB 0-1)
